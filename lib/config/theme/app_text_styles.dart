...
class AppTextStyles {
  // Heading Styles
  static TextStyle h1({Color? color, FontWeight? fontWeight}) => GoogleFonts.outfit(
    fontSize: 32,
  ...
  static TextStyle h2({Color? color, FontWeight? fontWeight}) => GoogleFonts.outfit(
    fontSize: 28,
    fontWeight: fontWeight ?? FontWeight.w700,
    color: color,
    height: 1.25,
  ...
  static TextStyle h3({Color? color, FontWeight? fontWeight}) => GoogleFonts.outfit(
    fontSize: 24,
  ...
  static TextStyle h4({Color? color, FontWeight? fontWeight}) => GoogleFonts.outfit(
    fontSize: 20,
    fontWeight: fontWeight ?? FontWeight.w600,
    color: color,
    height: 1.35,
  ...
  static TextStyle h5({Color? color, FontWeight? fontWeight}) => GoogleFonts.outfit(
    fontSize: 18,
    fontWeight: fontWeight ?? FontWeight.w600,
    color: color,
    height: 1.4,
  ...
  // Button Text
  static TextStyle button({Color? color, FontWeight? fontWeight}) => GoogleFonts.inter(
    fontSize: 16,
    fontWeight: fontWeight ?? FontWeight.w600,
    color: color,
    height: 1.2,
